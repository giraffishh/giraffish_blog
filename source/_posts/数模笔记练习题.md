...
```python
from unified_regressor import OptimizationSolver  # Assuming your class is saved here
...
```python
from unified_regressor import OptimizationSolver  # Assume your class is saved and imported
